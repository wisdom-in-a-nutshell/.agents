...
usage() {
  cat <<'EOF'
Usage: open-ghostty-plain-shell-split.sh [--direction right|down]

Open a Ghostty split pane that starts as a plain login shell without Codex
autostart. The split inherits the current Ghostty working directory.
EOF
}
