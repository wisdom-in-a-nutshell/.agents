...
Auto-apply the Codex control plane after the agents repo sync when tracked Codex files changed.
...
elif git -C "$AGENTS_REPO" diff --quiet "$last_sha" "$current_sha" -- codex config/global.agents.md; then
  should_apply=0
