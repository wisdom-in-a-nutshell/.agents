...
- Generated Obsidian registry views belong under `../docs/references/registry/`.
...
- `../docs/architecture/repo-scoped-agent-bootstrap.md`: repo-specific agent/bootstrap model.
