...
description: Applies synced WIN → AIP contracts by implementing the frontend UI and feature wiring for new/updated backend job or DTO endpoints. Use when Deploy on Main and Sync Contracts must finish before rebasing /Users/adi/GitHub/aipodcasting, updating UI, and committing/pushing with CI verification.
---
...
1. **Rebase + sync before edits**
   - Run `scripts/rebase_aipodcasting.sh` to commit any local changes, fetch, rebase, and push
     `/Users/adi/GitHub/aipodcasting` on `origin/main` before any edits.
...
3. **Wait for contract sync (no local export)**
   ...
   - Only proceed once generated contracts exist in `/Users/adi/GitHub/aipodcasting/lib/aip/contracts/`.
...
4. **Apply frontend changes**
   - Import generated contract types from `/Users/adi/GitHub/aipodcasting/lib/aip/contracts/...`.
   - Do **not** hand-edit generated contract files.
   - Implement the UI and hook wiring following codebase patterns:
     - Read `/Users/adi/GitHub/aipodcasting/lib/aip/AGENTS.md` for job/DTO patterns.
...
5. **Commit, push, verify CI**
   ...
   - Push and confirm CI passes for `/Users/adi/GitHub/aipodcasting`.
