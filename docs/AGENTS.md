...
- Keep reference docs only when they are exact lookup material, operational contracts, generated views, or source-of-truth maps. Delete or archive prose-only summaries that merely restate code, tests, or another doc.
