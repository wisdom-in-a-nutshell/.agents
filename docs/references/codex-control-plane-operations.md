...
- Check stale Codex Desktop sidebar projects without changing state:
  - [`prune-sidebar-projects.py`](/Users/dobby/GitHub/agents/codex/scripts/prune-sidebar-projects.py)
  - `~/GitHub/agents/codex/scripts/prune-sidebar-projects.py --plain`
...
- Install/update the nightly sidebar project prune LaunchAgent:
  - [`install-sidebar-project-prune-launchagent.sh`](/Users/dobby/GitHub/agents/codex/scripts/install-sidebar-project-prune-launchagent.sh)
...
- `~/.codex/auth.json` uses `auth_mode = "chatgpt"`. In the normal global default, `~/.codex/config.toml` leaves `model_provider` unset, so Codex uses the default OpenAI ChatGPT account provider. [`global.config.toml`](/Users/dobby/GitHub/agents/codex/config/global.config.toml) still pins `model = "gpt-5.5"` and reasoning defaults.
...
- [`install-sidebar-project-prune-launchagent.sh`](/Users/dobby/GitHub/agents/codex/scripts/install-sidebar-project-prune-launchagent.sh)
  ...
  - schedules [`prune-sidebar-projects.py`](/Users/dobby/GitHub/agents/codex/scripts/prune-sidebar-projects.py) at 01:00 daily by default, using its separate 2-day sidebar stale threshold
